...
export default function Home() {
  ...
  // PERUBAHAN 1: Menambahkan state untuk mengontrol PDF mana yang sedang dibuka di Modal
  ...
  const getCardStyle = (index: number) => {
    ...
    if (portfolioData.projects.length === 2) {
      if (index !== currentProject)
        return "translate-x-[25%] md:translate-x-[45%] scale-[0.8] z-20 opacity-40 cursor-pointer hover:opacity-70";
    }

    if (
      index === currentProject - 1 ||
      (currentProject === 0 && index === portfolioData.projects.length - 1)
    ) {
      return "-translate-x-[30%] md:-translate-x-[50%] scale-[0.8] z-20 opacity-40 cursor-pointer hover:opacity-70";
    }
    if (
      index === currentProject + 1 ||
      (currentProject === portfolioData.projects.length - 1 && index === 0)
    ) {
      return "translate-x-[30%] md:translate-x-[50%] scale-[0.8] z-20 opacity-40 cursor-pointer hover:opacity-70";
    }
    ...
    <main className="min-h-screen bg-[#0a0a0a] text-white selection:bg-white selection:text-black pb-20 font-sans overflow-hidden">
      ...
      <section className="relative w-full min-h-screen flex flex-col justify-center overflow-hidden pt-20 pb-32">
        ...
        <div className="relative z-20 max-w-[1400px] mx-auto w-full px-6 flex flex-col lg:flex-row justify-between items-center h-full gap-12 lg:gap-0 mt-32 lg:mt-0">
          <div className="lg:w-1/2 text-center lg:text-left">
            <p className="text-sm font-bold tracking-[0.2em] text-red-500 uppercase mb-2">
              Halo, Saya
            </p>
          ...
          <div className="lg:w-1/3 text-center lg:text-left flex flex-col justify-center items-center lg:items-start lg:pl-12 mt-48 lg:mt-0">
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
              <a
                href="#work"
                className="px-8 py-3.5 bg-white text-black font-bold rounded-full hover:bg-gray-200 transition-transform hover:scale-105 text-center"
              >
                Lihat Proyek &rarr;
              </a>
            </div>
      ...
      <section id="work" className="max-w-[1400px] mx-auto px-6 pt-32">
        <div className="flex flex-col md:flex-row md:justify-between md:items-end mb-24 gap-6">
          <div>
            <p className="text-xs font-bold tracking-[0.2em] text-zinc-500 uppercase mb-2">
              Selected Work
            </p>
            <h2 className="text-5xl md:text-6xl font-bold tracking-tight mb-4 flex items-center gap-2">
              Work Gallery{" "}
              <span className="animate-pulse font-light text-zinc-500">|</span>
            </h2>
            <p className="text-zinc-400 text-sm md:text-base">
              A collection of systems, digital projects, and technical work I've
              built.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-24 md:gap-32">
          {portfolioData.projects.map((project, index) => (
            <div
              key={index}
              // Baris ganjil akan di-reverse posisinya di layar besar (lg:flex-row-reverse)
            ...
            >
              ...
              <div className="w-full lg:w-1/2 flex flex-col items-start">
                {/* Kotak logo (opsional, bisa diganti dengan image logo jika ada di data.ts) */}
                {project.logo && (
                  <div className="relative w-32 md:w-40 h-12 md:h-16 mb-4 md:mb-6">
                    <Image
                      src={project.logo}
                ...
                <a
                  ...
                  className="text-sm font-bold text-white border-b border-transparent hover:border-white transition-all pb-1 flex items-center gap-2 group w-max"
                >
                  Read more{" "}
              ...
              <div className="w-full lg:w-1/2">
                <div className="relative w-full aspect-[4/3] md:aspect-[16/10] rounded-2xl overflow-hidden bg-[#111] border border-white/10 shadow-2xl group cursor-pointer">
                  <Image
                    src={project.image}
                    alt={project.title}
                    fill
        ...
        <div className="grid lg:grid-cols-12 gap-16 border-t border-white/10 pt-16">
          <div className="lg:col-span-5">
            ...
            <p className="text-zinc-400 mb-10 leading-relaxed">
              Saya menggabungkan keahlian teknis, pemecahan masalah, dan
              keterampilan digital untuk membangun sistem yang andal serta
              aplikasi modern berbasis mobile dan web.
            </p>
            <div className="flex flex-wrap gap-3">
              {portfolioData.skills.map((skill, index) => (
                <div
                  key={index}
                  className="w-auto h-12 px-5 bg-[#111] border border-white/10 rounded-xl flex items-center justify-center text-sm font-medium text-zinc-300 hover:bg-white/5 transition-colors"
                >
                  {skill}
                </div>
              ))}
          ...
          <div className="lg:col-span-7 grid md:grid-cols-2 gap-8">
            <div className="bg-[#111] p-8 rounded-3xl border border-white/5">
              <span className="text-4xl font-light text-zinc-600 mb-6 block">
                01
              </span>
              <h3 className="text-xl font-bold mb-4 uppercase tracking-wide text-zinc-200">
                Mobile & Web
                <br />
                Development
              </h3>
              <p className="text-sm text-zinc-400 leading-relaxed mb-8">
                Membangun dan menguji sistem digital dari database hingga
                aplikasi mobile menggunakan Flutter dan Express.js dengan fokus
                pada keandalan dan arsitektur yang bersih.
              </p>
            </div>
            <div className="bg-[#111] p-8 rounded-3xl border border-white/5">
              <span className="text-4xl font-light text-zinc-600 mb-6 block">
              ...
              <p className="text-sm text-zinc-400 leading-relaxed mb-8">
                Menerapkan algoritma cerdas seperti Rule-Based dan Clustering
                untuk menciptakan solusi inovatif dan adaptif pada permasalahan
                dunia nyata.
              </p>
            </div>
          </div>
              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-xs text-zinc-500">
                    {portfolioData.experiences[0].company}
                  </p>
                </div>
              </div>
      ...
      <section id="award" className="max-w-[1400px] mx-auto px-6 pt-32">
        <div className="border-t border-white/10 pt-16">
          ...
          <p className="text-zinc-400 mb-16 max-w-2xl text-sm md:text-base">
            A collection of academic and professional recognitions that reflect
            ...
            <div className="lg:col-span-7 grid grid-cols-2 sm:grid-cols-3 gap-3 md:gap-4">
              ...
              <div className="flex flex-col gap-3 md:gap-4 mt-0">
                <div className="relative w-full h-48 md:h-64 rounded-xl overflow-hidden border border-white/5">
                  <Image
                    src={portfolioData.recognitionPhotos[0]}
                    alt="Dokumentasi"
                    fill
                    className="object-cover"
                  />
                ...
                <div className="relative w-full h-32 md:h-40 rounded-xl overflow-hidden border border-white/5">
                  <Image
                    src={portfolioData.recognitionPhotos[3]}
                    alt="Dokumentasi"
                    fill
                    className="object-cover"
                  />
              ...
              <div className="flex flex-col gap-3 md:gap-4 mt-12 md:mt-20">
                <div className="relative w-full h-36 md:h-48 rounded-xl overflow-hidden border border-white/5">
                  <Image
                    src={portfolioData.recognitionPhotos[1]}
                    alt="Dokumentasi"
                    fill
                    className="object-cover"
                  />
                ...
                <div className="relative w-full h-44 md:h-56 rounded-xl overflow-hidden border border-white/5">
                  <Image
                    src={portfolioData.recognitionPhotos[4]}
                    alt="Dokumentasi"
                    fill
                    className="object-cover"
                  />
              ...
              <div className="hidden sm:flex flex-col gap-3 md:gap-4 mt-6 md:mt-10">
                <div className="relative w-full h-56 md:h-72 rounded-xl overflow-hidden border border-white/5">
                  <Image
                    src={portfolioData.recognitionPhotos[2]}
                    alt="Dokumentasi"
                    fill
                    className="object-cover"
                  />
        ...
        <div className="border-t border-white/10 pt-16">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {portfolioData.certificates.map((cert, index) => (
              <div
                key={index}
                className="bg-[#111] p-8 rounded-3xl border border-white/5 flex flex-col"
              >
                ...
                {/* PERUBAHAN 2: Mengubah tag <a> menjadi <button> agar mengontrol modal */}
                <button
                  onClick={() => setSelectedCert(cert.link)}
                  className="w-full text-left text-xs font-bold uppercase tracking-widest text-zinc-300 hover:text-white transition-colors border-t border-white/10 pt-4 flex items-center justify-between"
                >
      ...
      <section className="max-w-[1400px] mx-auto px-6 pt-32">
        <div className="border-t border-white/10 pt-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold tracking-tight mb-12">
            Mountain Logs <span className="text-zinc-600">|</span>
          </h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
            {portfolioData.mountains.map((mountain, index) => (
              <div
                key={index}
                className="relative rounded-2xl overflow-hidden h-40 group bg-black border border-white/5"
              >
                <Image
                  src={mountain.image}
                  alt={mountain.name}
      ...
      <section id="contact" className="max-w-[1400px] mx-auto px-6 pt-32">
        <div className="border-t border-white/10 pt-20 pb-12 flex flex-col lg:flex-row justify-between gap-16">
          <div className="lg:w-1/2">
            ...
            <a
              href="CV_Rizky_Alifian_Ilham_English.pdf"
              target="_blank"
              className="inline-flex items-center gap-2 px-6 py-3 border border-white/20 rounded-full text-sm font-bold hover:bg-white hover:text-black transition-all"
            >
              DOWNLOAD RESUME →
            </a>
          </div>
          ...
          <div className="lg:w-1/2 flex flex-col justify-center space-y-4">
            <a
              ...
              className="bg-[#111] border border-white/5 p-6 rounded-2xl flex justify-between items-center group hover:border-white/20 transition-colors"
            >
              <div>
            ...
            <a
              href="https://github.com/Alifian13"
              target="_blank"
              rel="noopener noreferrer"
              className="bg-[#111] border border-white/5 p-6 rounded-2xl flex justify-between items-center group hover:border-white/20 transition-colors"
            >
            ...
            <a
              href="https://linkedin.com/in/rizky-alifian-ilham-0a7a563a6"
              target="_blank"
              rel="noopener noreferrer"
              className="bg-[#111] border border-white/5 p-6 rounded-2xl flex justify-between items-center group hover:border-white/20 transition-colors"
            >
      ...
      {selectedCert && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/90 backdrop-blur-sm p-4 md:p-10">
          <div
            className="relative w-full max-w-5xl h-[85vh] bg-[#111] rounded-2xl overflow-hidden border border-white/10 shadow-2xl flex flex-col"
            onContextMenu={(e) => e.preventDefault()} // Mencegah user melakukan klik kanan -> "Save As"
          >
            ...
            <div className="flex justify-between items-center p-4 border-b border-white/10 bg-black/50">
              ...
              <button
                onClick={() => setSelectedCert(null)} // Menutup modal
            ...
            {/* Area Iframe untuk menampilkan sertif */}
            <div className="relative flex-1 w-full h-full bg-zinc-900 p-4 md:p-8 flex items-center justify-center overflow-auto">
              <div className="relative w-full max-w-4xl h-full pointer-events-none select-none">
                <Image
                  src={selectedCert}
